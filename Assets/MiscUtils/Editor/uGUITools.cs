...
// Credits and source please see: https://unity-ui-extensions.github.io/Controls/uGUITools.html

public class uGUITools : MonoBehaviour {
	[MenuItem(Settings.MISC_UTIL_PATH+"uGUI/Anchors to Corners %[")]
	...
	[MenuItem(Settings.MISC_UTIL_PATH+"uGUI/Corners to Anchors %]")]
	...
	[MenuItem(Settings.MISC_UTIL_PATH+"uGUI/Mirror Horizontally Around Anchors %;")]
	static void MirrorHorizontallyAnchors(){
		MirrorHorizontally(false);
	}

	[MenuItem(Settings.MISC_UTIL_PATH+"uGUI/Mirror Horizontally Around Parent Center %:")]
	...
	[MenuItem(Settings.MISC_UTIL_PATH+"uGUI/Mirror Vertically Around Anchors %'")]
	static void MirrorVerticallyAnchors(){
		MirrorVertically(false);
	}
	
	[MenuItem(Settings.MISC_UTIL_PATH+"uGUI/Mirror Vertically Around Parent Center %\"")]
