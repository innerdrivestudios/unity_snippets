...
2. MissingComponentUtility - remove all missing components from GameObjects and Prefabs automatically
...
6. StagedScreenshotUtility - stage your prefabs and turn them into transparent 2D sprites automatically
7. Attributes:
